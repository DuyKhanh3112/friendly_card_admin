...
import 'package:friendly_card_admin/views/admin/drawer_admin.dart';
          ...
          : SafeArea(
              child: Scaffold(
                ...
                appBar: AppBar(
                  centerTitle: true,
                  title: Text(
                    mainController.titleAdmin[mainController
                        .numPageAdmin
                        .value],
                  ),
                ...
                body:
                    mainController.pageAdmin[mainController.numPageAdmin.value],
