...
import 'package:friendly_card_admin/screens/question/question_managment_screen.dart';
import 'package:friendly_card_admin/screens/user/user_information_screen.dart';
import 'package:friendly_card_admin/screens/vocabulary/vocabulary_managment_screen.dart';
import 'package:friendly_card_admin/utils/inital_binding.dart';
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      getPages: [
        ...
        GetPage(
          name: '/vocabulary',
          page: () => const VocabularyManagmentScreen(),
        ),
        GetPage(
          name: '/question',
          page: () => const QuestionManagementScreen(),
        ),
      ],
    );
  }
