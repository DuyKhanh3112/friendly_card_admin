...
import 'package:friendly_card_admin/controllers/learner_controller.dart';
...
import 'package:friendly_card_admin/screens/learner/learner_managment_screen.dart';
import 'package:friendly_card_admin/screens/statistic/overview_screent.dart';
import 'package:friendly_card_admin/screens/topic/topic_managment_screen.dart';
import 'package:friendly_card_admin/screens/teacher/teacher_managment_screen.dart';
       ...
       <div style="width:600px; margin:auto; border:1px solid #dadce0; background-color:#f8fbff;
              ...
              <div style="margin-top:16px; font-size:24px; color:#5BC0DE;">
               ...
               <div style="font-size:16px; color:#5BC0DE; font-style:italic; margin-top:12px;">
                                <a href="https://drive.google.com/drive/folders/1I6Twul1I8r1Xv68CqIlC2Jf5ToVYYxtG?usp=drive_link">Nhấn vào đây để cài đặt ứng dụng desktop Firendly Card dành cho giáo viên.</a>
                        </div>
       </div>
</div>''';
