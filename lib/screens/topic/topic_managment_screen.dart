...
import 'package:friendly_card_admin/components/custom_button.dart';
import 'package:friendly_card_admin/components/custom_search_field.dart';
import 'package:friendly_card_admin/components/custom_text_field.dart';
import 'package:friendly_card_admin/controllers/main_controller.dart';
import 'package:friendly_card_admin/controllers/question_controller.dart';
import 'package:friendly_card_admin/controllers/teacher_controller.dart';
...
import 'package:friendly_card_admin/models/topic.dart';
import 'package:friendly_card_admin/models/vocabulary.dart';
import 'package:friendly_card_admin/utils/tool.dart';
import 'package:friendly_card_admin/widget/empty_data.dart';
import 'package:friendly_card_admin/widget/loading_page.dart';
import 'package:friendly_card_admin/models/users.dart';
import 'package:friendly_card_admin/utils/app_color.dart';
...
class TopicManagmentScreen extends StatelessWidget {
  ...
  void loadData(
    ...
    listTopic.value = topicController.listTopics.value
        .where(
          (item) => removeDiacritics(item.name.toUpperCase()).contains(
  ...
  Container topicItem(BuildContext context, Topic item) {
    ...
    if (usersController.user.value.role == 'teacher') {
      ...
      teacher =
          teacherController.listTeachers.value.firstWhereOrNull(
            (t) => t.id == item.user_id,
          ) ??
          Users.initTeacher();
    }
